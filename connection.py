...
try:
	...
	#connection = mysql.connector.connect(host='sql10.freesqldatabase.com', user='sql10482761', password='qEyF8wJVcN', database='sql10482761')
	connection = mysql.connector.connect(host='localhost', user='root', password='', database='easylub', port='8080')
